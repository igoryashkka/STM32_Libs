...
#define DS3231_REG_ALARM1_DAY 0xA// its the same as DS3231_REG_ALARM1_DATE
#define DS3231_REG_ALARM1_DATE 0xA// its the same as DS3231_REG_ALARM1_DAY

// ----- REG FOR ALARM 2 INFO 
#define DS3231_REG_ALARM2_MINUTES 0xB
#define DS3231_REG_ALARM2_HOURS 0xC
#define DS3231_REG_ALARM1_HOURS 0x09 
#define DS3231_REG_ALARM1_DAY 0xD// its the same as DS3231_REG_ALARM2_DATE
#define DS3231_REG_ALARM1_DATE 0xD// its the same as DS3231_REG_ALARM2_DAY
